...
public class IngFilterPresenterImp implements IngFilterPresenter {
    ...
    public IngFilterPresenterImp(FilteredView view, Context context) {
        this.view = view;
    ...
    public void getMealsByIngredient(String ingredient) {
        view.showLoading();
        disposable = repository.getMealsByIngredient(ingredient)
